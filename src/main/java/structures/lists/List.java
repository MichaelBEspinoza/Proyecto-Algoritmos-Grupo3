...
public interface List {
    ...
    public boolean contains(Object element) throws ListException, ListException; //true si el elemento existe en la lista
    ...
    public void sortbyId() throws ListException; //ordena la lista
